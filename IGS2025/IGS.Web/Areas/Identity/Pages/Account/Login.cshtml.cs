...
namespace IGS.Web.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, GlobalEnvironmentSetting globalEnvironmentSetting)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.IsLockedOut)
            {
                ...
                return Redirect(baseUrl + "igsadmin");
